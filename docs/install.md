...
```sh
curl -fsSL https://riftri.dev/install.sh | bash -s -- v0.3.3
```
...
bash "$installer_dir/install.sh" v0.3.3
```
...
For `v0.3.3`, the release assets are:

| System | Architecture | Archive |
| --- | --- | --- |
| macOS | Apple Silicon / ARM64 | `riftri-darwin-arm64-v0.3.3.tar.gz` |
| macOS | Intel / x64 | `riftri-darwin-x64-v0.3.3.tar.gz` |
| Linux with glibc | ARM64 / aarch64 | `riftri-linux-arm64-gnu-v0.3.3.tar.gz` |
| Linux with glibc | x64 / x86_64 | `riftri-linux-x64-gnu-v0.3.3.tar.gz` |
| Linux with musl | ARM64 / aarch64 | `riftri-linux-arm64-musl-v0.3.3.tar.gz` |
| Linux with musl | x64 / x86_64 | `riftri-linux-x64-musl-v0.3.3.tar.gz` |
| Windows | ARM64 | `riftri-win32-arm64-v0.3.3.tar.gz` |
| Windows | x64 | `riftri-win32-x64-v0.3.3.tar.gz` |
...
```sh
gh attestation verify riftri-darwin-arm64-v0.3.3.tar.gz --repo assistant-ui/riftri
```
...
Pin a release with `& $Installer -Version v0.3.3`. Set an absolute
...
```sh
node package/scripts/sync-homebrew-tap.mjs v0.3.3
```
